          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="index">
                ...
                <dd
                  changepirce="0"
                  @click="addActive(item1,item.spuSaleAttrValueList)"
...
export default {
  ...
  methods: {
    ...
    //点击事件触发更换class选项的
    addActive(item1, itemList) {
      if (item1.isChecked !== "1") {
        //如果isChecked的值不为1 ,说明没有被选中
        itemList.forEach(v => (v.isChecked = "0")); //遍历列表 ,想让所有的ischecked变为0
        item1.isChecked = "1"; //再让点击的变为1
      }
    },
    /* 
      当前图片下标发生改变的监听回调函数
  ...
  computed: {
    ...mapState({
      detailInfo: state => state.detail.detalInfo
    }),
    ...mapGetters([
      "categoryView",
      "skuInfo",
